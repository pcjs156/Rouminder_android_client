...
public class LocationGoal extends Goal{
     ...
     */
    public LocationGoal(GoalManager gm, int id, String name, LocalDateTime from, LocalDateTime to, int current, int target) {
        super(gm, id, name, from, to, current, target);
    }
